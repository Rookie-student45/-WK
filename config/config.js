var config = {
    ...
    welcome: "青青子衿，悠悠我心<br>" +
             "但为君故，沉吟至今<br>" +
             "你好，我是小可，蚌埠学院软件工程大三在读生<br>" +
             "很高兴见到你!",


    /*在这里配置关于我的信息，你可以内嵌HTML标签以调整格式*/
    about: "<p>你好！我叫小可，性别男，蚌埠学院软件工程学院大三在读。我期望的工作岗位是python/Java后端开发。</p>" +
    ...
    */  
     ...
     */
    portfolio: [
        ["./images/pro-1.png", "https://blog.csdn.net/CDSMM?spm=1000.2115.3001.5343", "个人博客", "这里记录了我的Java后端学习笔记<br>持续更新"],
        ["./images/pro-2.png", "https://github.com/happysnaker/Gobang", "智能人机对战五子棋", "采用C++编写的智能五子棋人机对战<br>2021/7/23"],
        ["https://pic3.zhimg.com/80/v2-d9766956d5c85c2780e4c5008fd946ca_1440w.jpg", "https://github.com/happysnaker/StudentsManageSystem", "学生管理系统", "java学生管理系统升级版"]
    ],
    ...
    work: [
        ...
        ["2019/9/1 — 2021/12/01", "<br>大学实习生",
            "<p><strong>大学经历</strong></p>" +
            "<p>待更新～</p>" +
            "<p>待更新～</p>"
        ],
     ...
     */
    others: [
        ["2021-04-28", "第十二届蓝桥杯大学生c组省三等奖", "大一下学期，我参与第十二届蓝桥杯大学生C组，然比赛一改以往暴力题，半数以上DP，仅取得省级三等奖。"],
     ...
     */
    icon: [
        ["./svg/github.svg", "https://github.com/Rookie-student45", "我的GitHub主页"],
        ["./svg/博客.svg", "http://124.221.16.220", "我的个人博客"],
        ["./svg/掘金.svg", "https://juejin.cn/user/3320956064374494", "我的掘金主页"],
        ["./svg/CSDN.svg", "https://blog.csdn.net/CDSMM?spm=1000.2115.3001.5343", "我的CSDN主页"],
    ],
